...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/evolution-guide/`, lastModified: siteConfig.lastUpdated, changeFrequency: 'weekly', priority: 0.9 },
    ...
    { url: `${baseUrl}/attributes/`, lastModified: siteConfig.lastUpdated, changeFrequency: 'monthly', priority: 0.8 },
